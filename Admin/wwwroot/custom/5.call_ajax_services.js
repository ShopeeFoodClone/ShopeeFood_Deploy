var _callAjax = (function () {
	...
	var _store = {
		...
		ActiveProduct: function (id) {
			var configAjax = {
				url: '/Admin/Store/ActiveProduct?idProduct=' + id,
				type: 'Get',
				beforeSend: function () { },
				complete: function () { },
				success: function (data) {
	...
	var _branchStore = {
		...
		FilterBranchStore: function ($form) {
			var request = {
				SearchText: $form.find("#searchText").val(),
				Sort: $form.find("#slc-sort-by option:selected").val(),
				Status: $form.find("#slc-sort-status option:selected").val(),
			...
			var configAjax = {
				url: '/Admin/BranchStore/FilterBranchStore',
				type: 'Post',
				data: JSON.stringify(request),
				success: function (res) {
					window.location.reload();
	...
	var _collection = {
		...
		ActiveCollection: function (id) {
			var configAjax = {
				url: '/Admin/Collection/ActiveCollection?idCollection=' + id,
				type: 'Get',
				beforeSend: function () { },
				complete: function () { },
				success: function (data) {
